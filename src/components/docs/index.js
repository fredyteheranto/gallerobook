    ...
    <div className="py-8 rounded-3xl max-w-full text-white bg-gray-800">
      ...
      <section className="px-3 md:px-8 my-16">
        ...
        <div className="mt-5 mb-12">
          ...
          <div className="flex flex-wrap md:flex-nowrap pl-6 mt-4">
            ...
            <p className="pl-2">
              ...
              logic is placed. this will then be reused in other components. it handles the closing
              of the sidenav when the route changes or on click outside.
            </p>
          </div>
          <div className="flex flex-wrap md:flex-nowrap pl-6 mt-6">
            ...
            <p className="pl-2">
              displays an overlay that will only be visible on small screens to emphasize the focus
              on the sidenav when it is open
            </p>
          </div>
        </div>
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-wrap md:flex-nowrap pl-6 mt-4">
            ...
            <p className="pl-1">
              As each <strong>sidenav-item</strong> has an icon, this sub-folder contains the icons
              of each sidenav-item. You don't need this folder if you are using a package for icons
              such as
          ...
          <div className="flex flex-wrap md:flex-nowrap pl-6 mt-10">
            ...
            <p className="pl-1">
              The<strong className="px-1">SidenavHeader</strong>component contains the logo that is
          ...
          <div className="flex flex-wrap md:flex-nowrap pl-6 mt-6">
            ...
            <p className="pl-1">
              This<strong className="px-1">SidenavItems</strong>component automatically generates
              each sidenav-item according to your routes coming from the
        ...
        <div>
          ...
          <div className="flex flex-wrap md:flex-nowrap pl-6 mt-4">
            ...
            <p className="pl-1">
              Contains the
              <strong className="px-1">Topnavigation</strong>component. You can customize it or
              replace it with your own navbar but don't forget to add a button to toggle sidenav on
              mobile
            </p>
          </div>
        </div>
      ...
      <section className="px-3 md:px-8 my-16">
        ...
        <div className="mt-4">
          ...
          <strong className="px-1">prettier</strong>,<strong className="px-1">lint-staged</strong>et
          <strong className="px-1">husky.</strong>Before each commit, the
          <strong className="px-1">pre-commit</strong>hook will be triggered to run prettier to
      ...
      <section className="px-3 md:px-8 my-16">
        ...
        <p className="mt-4">
          As there is no vendor lock-in, if you already have a dashboard, you can just copy the
      ...
      <section className="px-3 md:px-8 my-16">
        ...
        <p className="mt-5">
          The sidenav scrollbar is hidden by default but you can still scroll with the keyboards if
          you have several sidenav-items. If you are not a fan of this approach, you can always
        ...
        <p className="mt-5">
          ...
          <strong className="pl-1">mobilePosition</strong>, which indicates the positioning of the
          sidenav on mobile.
        </p>
      ...
      <section className="px-3 md:px-8 mt-16">
        ...
        <p className="mt-5">
          If you'll need some UI components for Tailwind CSS such as modal, accordion, dropdown, tab
          or other components, you can check out
          <a
            target="_blank"
          ...
          , a collection of fully customizable UI components, without any installation, just copy
          and paste the component you want to use.
        </p>
      </section>
    </div>
  );
