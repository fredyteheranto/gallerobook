export const Madres = ({ imagen, fecha, nombre, placa, pluma }) => (
  <div className="border-t solid border-gray-700 p-4 flex 2xl:items-start w-full hover:bg-gray-700">
    <img
      src={imagen || 'https://i.postimg.cc/qMJDfbR5/Whats-App-Image-2022-08-15-at-10-41-48-AM.jpg'}
      alt="profile image"
    ...
    <div className="pl-4 w-full">
      ...
      <p className="my-2 text-sm text-gray-400">Madre placa #1209 traida de europa</p>
